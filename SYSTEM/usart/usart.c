...
//蓝牙接收的变量
//__IO uint8_t aRxBuffer[100]={0x00};
...
//	{
//			Clear=USART3->SR;
//			Clear=USART3->DR;		//清除IDLE中断  取出就清除
//			ReceiveState=1; //标志接收到了一帧数据
//	}
//	receiveDo();
//	
...
//char str[100]={0},RecDate;  //为什么做为局部变量会有个初值？
//void receiveDo(void){		//对蓝牙接收到的数据的处理  待增改！！
//	int n,i=0;
//	
//			if(ReceiveState==1){
//				ReceiveState=0;		
...
//	{
//		Co2[Co2_mount]=USART_ReceiveData(UART4);
//		Co2_mount++;
//	}
//	
