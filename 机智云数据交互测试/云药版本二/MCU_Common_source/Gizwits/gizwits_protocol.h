...
#define typesef_t __packed typedef	// 添加结构体字节对齐
...
* @{
*/
#define PRODUCT_KEY "88670722f4b54a898a683aea9b65edd4"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "8a08a348ab554b59bec0c66cde41d0f7"
...
* @{
*/
#define temp_alarm_BYTEOFFSET                    52
#define temp_alarm_BITOFFSET                     0
#define temp_alarm_LEN                           1
#define hum_alarm_BYTEOFFSET                    52
#define hum_alarm_BITOFFSET                     1
#define hum_alarm_LEN                           1
